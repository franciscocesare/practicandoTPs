...
void mostrarAlquiler(eAlquileres vec, eJuego juegos[], int tamJ, eCliente lista[], int tamC)
{
    ...
    printf(" %2d  %8s  %8d       %02d/%02d/%d\n",
           ...
           nomjuego,
           vec.idCliente,
           vec.fechaAlquiler.dia,
           vec.fechaAlquiler.mes,
           vec.fechaAlquiler.anio);
}
...
*
*/
int altaAlquiler(eAlquileres vec[], int tam, eJuego juegos[], int tamJ, eCliente lista[], int tamC,eCategoria categorias[], int tCat, int id, eLocalidad localidad[], int tamLoc)
{
    int todoOk=0;
    int indice;
    ...
    else
    {
        ...
        mostrarClientes(lista,tamC, localidad, tamLoc);
